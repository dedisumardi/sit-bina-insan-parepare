...
(1, 'Penerimaan Murid Baru (SPMB) TP. 2025/2026 Gelombang 1 Resmi Dibuka', 'Info SPMB', 'badge-spmb', 'Panitia SPMB', '15 Januari 2025', '3 menit baca', 'assets/images/hero_school.jpg', 'SIT Bina Insan Parepare membuka kesempatan bagi putra-putri terbaik untuk bergabung di jenjang TKIT, SDIT, dan SMPIT dengan kuota terbatas.', '<p>Alhamdulillah, pendaftaran peserta didik baru (SPMB) SIT Bina Insan Parepare untuk Tahun Pelajaran 2025/2026 resmi dibuka. Kami membuka pendaftaran untuk tiga jenjang pendidikan terpadu: TKIT, SDIT, dan SMPIT.</p><p>Pada Gelombang 1 (Early Bird) ini, calon murid berkesempatan mendapatkan potongan infaq sarana pendidikan khusus serta prioritas pemilihan jadwal observasi dan pemetaan potensi santri.</p><p>Pendaftaran dapat dilakukan secara mandiri melalui website resmi ini dengan mengisi formulir online 5 langkah, kemudian mengunduh Kartu Tanda Peserta untuk dibawa saat observasi berlangsung.</p>'),
(2, 'Santri SDIT Bina Insan Raih Juara 1 Olimpiade Sains & Koding Cilik se-Ajatappareng', 'Prestasi', 'badge-prestasi', 'Humas SIT', '10 Januari 2025', '2 menit baca', 'assets/images/sdit_recitation.jpg', 'Prestasi membanggakan kembali diukir oleh ananda Muhammad Ziyad dari kelas 5 SDIT dalam ajang kompetisi sains dan logika koding usia dasar.', '<p>Prestasi membanggakan kembali ditorehkan oleh santri SDIT Bina Insan Parepare dalam ajang Kompetisi Sains & Algoritma Cilik Tingkat Wilayah Ajatappareng tahun 2025.</p><p>Ananda Muhammad Ziyad berhasil menyabet Juara 1 setelah berhasil menyelesaikan proyek sains terapan dan pemrograman berbasis blok interaktif. Keberhasilan ini membuktikan bahwa pendidikan terpadu di SIT Bina Insan tidak hanya unggul dalam hafalan Al-Qur\'an dan akhlak, namun juga berdaya saing tinggi dalam sains dan teknologi modern.</p>'),
(3, 'Wisuda Tahfizh Al-Qur\'an Angkatan IX: Lahirkan 45 Penghafal Qur\'an Mutqin', 'Kegiatan Sekolah', 'badge-kegiatan', 'Tim Tahfizh', '5 Januari 2025', '4 menit baca', 'assets/images/smpit_students.jpg', 'Yayasan Bina Insan Parepare menggelar Wisuda Tahfizh Akbar dengan kelulusan santri kategori 3 Juz, 5 Juz, hingga 10 Juz Mutqin.', '<p>Sebanyak 45 santri dari jenjang SDIT dan SMPIT Bina Insan Parepare mengikuti prosesi Wisuda Tahfizh Akbar Angkatan IX yang diselenggarakan di Aula Utama Kampus SIT Bina Insan Parepare.</p><p>Prosesi wisuda diawali dengan uji tasmi\' hafalan Al-Qur\'an secara terbuka di hadapan para orang tua murid dan dewan asatidz. Air mata haru dan syukur mewarnai penyematan mahkota kemuliaan oleh para santri kepada kedua orang tua mereka.</p>')
